...
class Button(pygame.sprite.Sprite):
    def __init__(self, x, y, width, height, text, fontpath, fontsize, fontcolor, bgcolors, edgecolor, edgesize=1,
                 is_want_to_be_selected=True, screensize=None, **kwargs):
...
def main():
    ...
    button_yes = Button(x=20, y=cfg.SCREENSIZE[1] - 70, width=120, height=35,
                        ...
                        edgesize=2, bgcolors=[cfg.DARKGRAY, cfg.GAINSBORO], is_want_to_be_selected=True,
    ...
    button_no = Button(x=cfg.SCREENSIZE[0] - 140, y=cfg.SCREENSIZE[1] - 70, width=120, height=35,
                       ...
                       edgesize=1, bgcolors=[cfg.DARKGRAY, cfg.GAINSBORO], is_want_to_be_selected=False,
                       screensize=cfg.SCREENSIZE)
    # 是否点击了好呀按钮
    is_agree = False
    # 主循环
